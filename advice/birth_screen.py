...
class BirthScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.steps = {
            1: {"image": 'img\\1.png', "text": "Текст шага 1", "title": "Роды питомца", "button": "Далее"},
            2: {"image": 'img\\2.png', "text": "Текст шага 2", "title": "Роды питомца", "button": "Далее"},
            3: {"image": 'path/to/image1.png', "text": "Текст шага 3", "title": "Роды питомца", "button": "Выход"},
