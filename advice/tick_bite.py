...
class Tick_bite(Screen):
    def __init__(self, **kwargs):
        ...
        self.steps = {
            ...
            3: {"image": 'img\\tick_bite\\шаг3.png', "text": "Шаг 3: Удаляйте легкими вращательными движениями, постарайтесь не тянуть, избегайте рывков, чтобы не оторвать голову кровососа, которая в таком случае останется в ранке", "title": "Укус клеща", "button": "Далее"},
